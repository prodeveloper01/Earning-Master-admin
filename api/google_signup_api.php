    ...
    if (!empty($method) && $method == "regUser") {
        ...
        if ($result->num_rows > 0) {
            echo "email already registered";
                ...
                VALUES ('$name', '$email', '$password', '$username', '$phone', '$user_country', '$device_id', '$refer', '$user_id', '$image' , '$sign_up_bonus', '$collect_count_ava', '$open_count_ava', '$ads_scratch_count_ava' , '$ex_scratch_count_ava', '$gr_scratch_count_ava', '$eve_count_ava' , '$tic_tac_toe_count_ava', '$video_wall_ava', '$spin_count_ava')";
