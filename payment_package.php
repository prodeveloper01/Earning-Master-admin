...
<div class="main_content_iner " style="min-height:0;margin-bottom: 0px;">
  <div class="card">
    ...
    <div class="card-body">
      <form action="admin_api/payment_api.php" method="post" id="myform" enctype="multipart/form-data">
            ...
            <div class="col-lg-12">
             ...
             <div class="col-lg-12">
              <div class="common_input mb_15">
                ...
                <input style="background: lavender;" type="hidden" name="symbol" value="<?php echo $_GET['symbol']; ?>">
              </div>
            </div>
...
$id = $_GET['i'];
$sql = "SELECT * FROM payment_package WHERE payment_id = '$id'";
$offer = mysqli_query($conn, $sql);
...
<tr>
    ...
    <th scope="col">
        ...
        <form action="admin_api/api.php?user_id=<?php echo $offer_row['id']; ?>" method="POST">
                            <input type="hidden" name="_method" value="DELETE_PAYMENT_PACKAGE">

                            <input type="hidden" name="py_idd" value="<?php echo $id; ?>">
                            <button style="border: none;" type="submit" class="action_btn"> <i class="fas fa-trash"></i>
                </button>
                        </form>
